...
const typeGradients: Record<string, string> = {
  noticia: 'from-blue-100 to-blue-200',
  evento: 'from-accent-100 to-accent-200',
  festividad: 'from-yellow-100 to-orange-200',
  actividad: 'from-green-100 to-emerald-200',
};
...
export default function NewsDetail() {
  ...
  return (
    <DetailLayout
      ...
      gradient={typeGradients[item.type] || 'from-primary-100 to-accent-100'}
      badge={item.type}
      title={item.title}
      subtitle={item.eventDate ? (
        <p className="text-primary-600/90 flex items-center gap-2 mt-4">
