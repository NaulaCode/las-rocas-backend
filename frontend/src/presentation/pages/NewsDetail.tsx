...
export default function NewsDetail() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO title={item.title} description={item.summary || item.content} />
      <div className={`relative bg-gradient-to-br ${typeGradients[item.type] || 'from-primary-600 to-accent-600'} py-16 md:py-20 overflow-hidden`}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <Link to="/noticias" className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-6 transition-colors">
