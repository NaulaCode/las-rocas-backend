...
export default function TouristicAttractionDetail() {
  ...
  return (
    <DetailLayout
      loading={loading}
      seoTitle={attraction.name}
      seoDescription={attraction.description}
      gradient={gradient}
      badge={categoryLabels[attraction.category] || attraction.category}
      title={attraction.name}
      backTo={{ path: '/atractivos', label: t('attractionDetail.volver') }}
      sidebar={
        <div className="space-y-6">
          <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
          ...
          <div className="bg-gradient-to-br from-emerald-600 to-teal-600 rounded-2xl shadow-sm p-6 text-white">
      ...
      <div className="space-y-8">
        {attraction.image && (
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-100 shadow-sm overflow-hidden cursor-pointer group"
            onClick={() => setLightboxIndex(0)}
          >
            <div className="relative">
              <img src={attraction.image} alt={attraction.name} className="w-full h-80 md:h-96 object-cover group-hover:scale-105 transition-transform duration-700" />
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8 relative overflow-hidden"
        >
