...
function StatCard({ value, label, gradient, delay = 0 }: { value: string; label: string; gradient: string; delay?: number }) {
  ...
  return (
    ...
    >
      <div className={`text-4xl md:text-5xl font-bold bg-gradient-to-br ${gradient} bg-clip-text text-transparent mb-1`}>
...
export default function Conocenos() {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <motion.span initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
              className="inline-block px-5 py-2 bg-white/10 backdrop-blur-md rounded-full text-sm text-primary-100 border border-white/10 mb-8 tracking-wider">
              ASOTURLASROCAS
            </motion.span>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight">
              {org?.pageContent?.conocenos?.title || 'Conócenos'}
            </h1>
            <p className="text-lg md:text-xl text-primary-200 max-w-3xl mx-auto leading-relaxed font-light">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
              ...
              <a href="#historia" className="px-8 py-3.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl font-semibold hover:bg-white/20 transition-all">
                Conoce nuestra historia
              </a>
              <a href="#ubicacion" className="px-8 py-3.5 bg-accent-500 rounded-xl font-bold hover:bg-accent-600 transition-all shadow-lg shadow-accent-500/25">
                Cómo llegar
              </a>
            </motion.div>
          </motion.div>
      ...
      <section className="relative -mt-20 z-20">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="bg-gradient-to-r from-primary-800 via-primary-700 to-primary-800 rounded-3xl shadow-2xl shadow-primary-900/20 px-8 md:px-16 py-10 max-w-5xl mx-auto"
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.slice(0, 4).map((s, i) => (
                <StatCard key={s.label} value={s.value} label={s.label}
                  gradient={['from-emerald-300 to-emerald-100', 'from-accent-300 to-accent-100', 'from-primary-200 to-primary-100', 'from-amber-300 to-amber-100'][i]}
                  delay={i * 0.1} />
              ))}
            </div>
          </motion.div>
      ...
      {/* ─── HISTORIA ─── */}
      <section id="historia" className="py-28 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div variants={pageAnim} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} className="max-w-4xl mx-auto">
            <motion.div variants={item} className="text-center mb-14">
              <span className="text-sm font-bold text-accent-500 uppercase tracking-[0.2em]">Nuestra Historia</span>
              ...
              <div className="space-y-10">
                {historyParagraphs.map((p: string, i: number) => (
                  <motion.div key={i}
                    ...
                    <div className="hidden md:flex absolute left-3 top-2 w-10 h-10 bg-white border-2 border-primary-200 rounded-full items-center justify-center shadow-md">
                      <span className="text-sm font-bold text-primary-600">{i + 1}</span>
                    </div>
                    <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-100 hover:shadow-lg transition-shadow duration-300">
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="absolute top-0 left-1/4 w-80 h-80 bg-primary-50 rounded-full blur-3xl -translate-y-1/2 pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
            <motion.div variants={pageAnim} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }}>
              <div className="grid md:grid-cols-2 gap-6 lg:gap-10">
                <motion.div variants={item} className="group">
                  <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 h-full relative overflow-hidden">
                    <div className="absolute -top-16 -right-16 w-40 h-40 bg-primary-50 rounded-full group-hover:scale-[4] transition-transform duration-1000 opacity-60" />
                    <div className="relative z-10">
                      <div className="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl flex items-center justify-center mb-6 shadow-xl shadow-primary-500/20 group-hover:scale-110 transition-transform duration-300">
                ...
                <motion.div variants={item} className="group">
                  <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 h-full relative overflow-hidden">
                    <div className="absolute -top-16 -right-16 w-40 h-40 bg-accent-50 rounded-full group-hover:scale-[4] transition-transform duration-1000 opacity-60" />
                    <div className="relative z-10">
                      <div className="w-16 h-16 bg-gradient-to-br from-accent-500 to-accent-700 rounded-2xl flex items-center justify-center mb-6 shadow-xl shadow-accent-500/20 group-hover:scale-110 transition-transform duration-300">
                        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #f0fdf4 0%, #ecfdf5 50%, #fefce8 100%)' }}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.6 }} className="text-center mb-16">
            <span className="text-sm font-bold text-emerald-600 uppercase tracking-[0.2em]">Conservación</span>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-16">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
              ...
              <p className="text-gray-500 text-sm mt-3 leading-relaxed">Equivalente a más de 3,900 canchas de fútbol, hogar de cientos de especies de flora y fauna.</p>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}
              ...
              <div className="text-4xl md:text-5xl font-bold bg-gradient-to-br from-amber-500 to-orange-600 bg-clip-text text-transparent mb-2 leading-tight">
                Rana Militar<br />Arlequín
              </div>
              <p className="text-gray-500 text-sm leading-relaxed">Especie emblemática de nuestra zona. El bosque húmedo tropical de Naranjal alberga una biodiversidad única con especies endémicas y migratorias.</p>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}
              ...
              <p className="text-gray-500 text-sm mt-3 leading-relaxed">Explora senderos ecológicos, recorre plantaciones de cacao y café, y conecta con las tradiciones agrícolas de la comuna San Miguel.</p>
            </motion.div>
          </div>

          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }}
            className="max-w-3xl mx-auto">
            <div className="backdrop-blur-xl bg-white/50 border border-white/40 rounded-2xl p-6 md:p-8 text-center shadow-sm">
              <p className="text-gray-600 leading-relaxed text-base md:text-lg">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-primary-50 rounded-full blur-3xl pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          <motion.div variants={pageAnim} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} className="max-w-5xl mx-auto">
            <motion.div variants={item} className="text-center mb-14">
              <span className="text-sm font-bold text-accent-500 uppercase tracking-[0.2em]">Nuestra Filosofía</span>
              <h2 className="text-4xl md:text-5xl font-bold mt-2">
                <span className="gradient-text">{org?.pageContent?.conocenos?.valuesTitle || 'Nuestros Valores'}</span>
              </h2>
              <SectionDivider />
              <p className="text-gray-500 max-w-xl mx-auto mt-4">Principios que guían cada experiencia que ofrecemos.</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {values.map((val: { title: string; desc: string }, i: number) => {
                ...
                return (
                  <motion.div key={val.title} variants={item}
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent-50 rounded-full blur-3xl translate-x-1/3 translate-y-1/3 pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.6 }}
            className="text-center mb-14">
            <span className="text-sm font-bold text-accent-500 uppercase tracking-[0.2em]">Experiencias</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-2 mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {(org?.pageContent?.conocenos?.activities || [
              ...
              <motion.div key={i}
                ...
                <div className="w-14 h-14 bg-gradient-to-br from-accent-400 to-accent-600 rounded-2xl flex items-center justify-center mb-5 shadow-md group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {i === 2 && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />}
                    {i === 3 && <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />}
                  </svg>
                </div>
                <h3 className="text-lg font-bold text-gray-800 mb-3">{a.title}</h3>
      ...
      {/* ─── COMPROMISO ─── */}
      <section className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #064e3b 0%, #065f46 50%, #047857 100%)' }}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
            ...
            <motion.span initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              className="inline-block px-4 py-1.5 bg-white/10 backdrop-blur-sm rounded-full text-sm text-emerald-200 border border-white/10 mb-6">
              COMPROMISO
            </motion.span>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Nuestro Compromiso</h2>
            <div className="w-16 h-1 bg-accent-400 rounded-full mx-auto mb-8" />
            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }}
              ...
              <Link to="/servicios" className="inline-flex items-center gap-2 bg-accent-500 text-white px-8 py-3.5 rounded-xl font-bold hover:bg-accent-600 transition-all shadow-lg shadow-accent-500/30">
                Ver Servicios
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </Link>
              <Link to="/contacto" className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-8 py-3.5 rounded-xl font-bold border border-white/20 hover:bg-white/20 transition-all">
                Contáctanos
              </Link>
            </motion.div>
          </motion.div>
      ...
      {/* ─── UBICACIÓN ─── */}
      <section id="ubicacion" className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.6 }}
            className="text-center mb-14">
            <span className="text-sm font-bold text-accent-500 uppercase tracking-[0.2em]">Ubicación</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-2 mb-4">
              <span className="gradient-text">Cómo llegar</span>
            </h2>
            <SectionDivider />
            <p className="text-gray-500 text-lg max-w-2xl mx-auto mt-4">Descubre cómo llegar a Las Rocas y vive una experiencia inolvidable en la comuna San Miguel.</p>
          </motion.div>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }}
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  <div className="bg-white rounded-xl p-2 border border-gray-200 shadow-sm">
                    <img src={`https://api.qrserver.com/v1/create-qr-code/?size=400x400&data=${encodeURIComponent('https://www.google.com/maps?q=-2.760096,-79.626700')}`}
                      alt="QR Google Maps" className="w-64 h-64" loading="lazy"
              ...
              <motion.div whileHover={{ scale: 1.01 }} className="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
                <div className="aspect-video w-full">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3986.229836823826!2d-79.626700!3d-2.760096!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMsKwNDUnMzYuMyJTIDc5wrAzNyczNi4xIlc!5e0!3m2!1ses!2sec!4v1"
                    className="w-full h-full" style={{ minHeight: '250px' }} allowFullScreen loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade" title="Mapa de Google Maps - Las Rocas" />
                </div>
                <div className="p-4 bg-white text-center">
                  <a href="https://www.google.com/maps?q=-2.760096,-79.626700" target="_blank" rel="noopener noreferrer"
