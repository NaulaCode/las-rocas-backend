...
export default function NewsTab({ news, org, searchTerm, setSearchTerm, filterValue, setFilterValue, openCreate, openEdit, setDeleteId }: Props) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-2">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => exportNewsPDF(filtered, org)}
