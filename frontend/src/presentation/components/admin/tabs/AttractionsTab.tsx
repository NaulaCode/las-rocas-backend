...
export default function AttractionsTab({ attractions, org, searchTerm, setSearchTerm, filterValue, setFilterValue, openCreate, openEdit, setDeleteId }: Props) {
    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-5">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => exportAttractionsPDF(filtered, org)}
